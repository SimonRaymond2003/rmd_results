...
```{r}
cols_to_remove <- c(
    "offense_player_3_present",
    "offense_player_7_present",
    "offense_player_13_present",
    "offense_player_18_present",
    "offense_player_19_present",
    "offense_player_21_present",
    "defense_player_7_present",
    "defense_player_8_present",
    "offense_player_10_weeks_found_2w",
    "offense_player_9_weeks_found_12w"
)

# Remove these columns from outcome_data
...
cat(sprintf("%-*s  %10s  %10s  %10s  %4s\n", name_width, "Variable", "Coef", "t-value", "p-value", "sig"))
cat(sprintf("%-*s  %10s  %10s  %10s  %4s\n", name_width, "---------", "----", "-------", "-------", "---"))
