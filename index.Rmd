...
The key points about how down4_pct is calculated:\

- It only includes actual running and passing plays (excludes punts, field goals, etc.)\
- Counts the cumulative number of run plays on 4th down\
- The calculation is cumulative, meaning it includes all previous weeks of the season
