...
```{r}
# ctd1$winning_score_diff <- NULL
# ctd1$losing_score_diff <- NULL
```

```{r}
 # makew losing_score_diff absolute value
#ctd1$losing_score_diff <- abs(ctd1$losing_score_diff)
```
...
# Get robust statistics and print results
robust_regular_test <- coeftest(ols_regular, vcov = vcovHC(ols_regular, type = "HC0"))
format_results(robust_regular_test, "Regular Players OLS")
```
...
```{r}
# Get robust statistics and print results for starter players
robust_starter_test <- coeftest(ols_starter, vcov = vcovHC(ols_starter, type = "HC0"))
format_results(robust_starter_test, "Starter Players OLS")
```
...
```{r}
# Format probit results using consistent formatting
...
# Get robust statistics and print results for regular probit
robust_probit_regular <- coeftest(probit_regular, vcov = vcovHC(probit_regular, type = "HC0"))
format_probit_results(robust_probit_regular, "Regular Players Probit")
```
...
```{r}
# Get robust statistics and print results for starter probit
robust_probit_starter <- coeftest(probit_starter, vcov = vcovHC(probit_starter, type = "HC0"))
format_probit_results(robust_probit_starter, "Starter Players Probit")
```
